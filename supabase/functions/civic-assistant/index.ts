...
- Election Commission Helpline: 105`;
    ...
    // Add instruction to include follow-up questions at the end
    const enhancedSystemPrompt = systemPrompt + `

IMPORTANT: At the end of your response, suggest 3 relevant follow-up questions to help the user learn more. Format them exactly like this:
[FOLLOWUP]
1. First question
2. Second question  
3. Third question
